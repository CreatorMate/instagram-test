...
const verifyEmailTemplate = function (
    ...
    <div style="display: none;">${brandName} has invited you to work with them, click the link underneath to go to accept this invite profile information</div>
                                    ...
                                    <tr>
                                        <td class="sm-px-24"
                                            ...
                                            <p style="margin: 0 0 16px;">
                                                ...
                                                <a href="mailto:hello@creatormate.com" class="hover-underline"
                                                   style="--text-opacity: 1; color: #7367f0;  text-decoration: none;">hello@creatormate.com</a>.
                                            </p>
                                            <p style="margin: 0 0 16px;">Kindest regards <br>jens</p>
                                        </td>
                                    </tr>
                                    <tr>
